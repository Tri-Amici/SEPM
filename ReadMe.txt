...
2. Unpack the zip file to H:\ You should see H:\Group_9_SEPM_A2_FinalSprint\code\...

3. Open the JDK command prompt and navigate to the java project source files:
	cd "Group_9_SEPM_A2_FinalSprint\code\src\org\triamici\"

4. Compile the Java files using the following command:
	javac --release 8 *.java
	
5. Navigate up two levels to the folder: "Group_9_SEPM_A2_FinalSprint\code\src\"
	cd ..\..\
